...
export default function AddForm({ consoles }: any) {

    const [errors, setErrors]          = useState<any>({});
    const [preview, setPreview]        = useState('/imgs/no-cover.png');
            ...
            {showToast && (
                <div className="toast toast-top toast-end">
                    <div className="alert alert-success">
                        <span>Game: <strong>{form.title}</strong> created successfully</span>
                    </div>
                </div>
            )}
      <form
        ...
        <fieldset disabled={showToast || isPending} className="contents">
          ...
          <div>
            ...
            >
              ...
              {isPending ? "Saving..." : showToast ? "Redirecting..." : "Create Game"}
            </button>
