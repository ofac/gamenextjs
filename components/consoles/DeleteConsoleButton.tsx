...
export default function DeleteConsoleButton({ console }: { console: { id: number; name: string } }) {
        ...
        >
            <div className="bg-base-100 rounded-2xl p-8 w-full max-w-md mx-4">
                ...
                <p className="text-base text-base-content/80 mb-6">
                     you want to delete{" "}
                    <span className="font-semibold text-base-content">{console.name}</span>
                </p>
            ...
            {showToast && typeof window !== "undefined" && createPortal(
                <div className="toast toast-top toast-end z-50">
                    <div className="alert alert-success">
                        <span>Console: <strong>{console.name}</strong> deleted successfully</span>
                    </div>
                </div>,
                document.body
            )}
